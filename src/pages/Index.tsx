...
const PRICING = [
  {
    ...
    rows: [
      ...
      ['Замена вентиля', '250 ₽'],
      ['Подкачка шин (4 колеса)', '200 ₽'],
      ['Диагностика резины', 'Бесплатно'],
    ],
  },
  {
    ...
    rows: [
      ...
      ['Подкачка грузовых шин', '500 ₽'],
      ['Ремонт прокола (грузовой жгут)', '1 100 ₽'],
      ['Полный комплект фуры (18 колёс)', '14 000 ₽'],
    ],
  },
  {
    title: 'Диски и доп. услуги',
    icon: 'Settings',
    rows: [
      ['Правка литого диска', '1 500 ₽'],
      ['Правка стального диска', '800 ₽'],
      ['Замена золотника (ниппеля)', '150 ₽'],
      ['Снятие прикипевшего колеса', '600 ₽'],
      ['Монтаж/демонтаж докатки', '300 ₽'],
      ['Обмыловка колеса (поиск утечки)', '200 ₽'],
      ['Чистка посадочного места диска', '350 ₽'],
      ['Накачка азотом (1 колесо)', '150 ₽'],
    ],
  },
  {
    title: 'Хранение и VIP',
    icon: 'Package',
    rows: [
      ['Хранение шин (сезон, 4 шт.)', '1 500 ₽'],
      ['Хранение колёс в сборе (4 шт.)', '2 000 ₽'],
      ['Доставка шин из хранилища', '500 ₽'],
      ['VIP-выезд (приоритет, 10 мин)', '1 500 ₽'],
      ['Корпоративный абонемент (мес.)', '5 000 ₽'],
      ['Выезд за МКАД (до 20 км)', '800 ₽'],
      ['Выезд за МКАД (20–50 км)', '1 500 ₽'],
      ['Ночной выезд (00:00–06:00)', '300 ₽'],
    ],
  },
];
